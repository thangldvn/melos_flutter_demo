      ...
      _entry = OverlayEntry(builder: (_) {
        return Align(
          ...
          child: Container(
            ...
            child: const ConsoleOverlayWidget(),
          ),
        );
      });
...
class ConsoleOverlayWidget extends StatefulWidget {
  const ConsoleOverlayWidget({Key? key}) : super(key: key);
...
class _ConsoleOverlayWidgetState extends State<ConsoleOverlayWidget> {
  final ValueNotifier<FilterMenu> _menuValue = ValueNotifier(FilterMenu(10, true));
                    ...
                    children: _logLevelFilter.map((value) {
                      return Column(
                        children: [
                          ...
                          Offstage(offstage: value.contains('取消'), child: _divider),
                        ],
                      );
                    }).toList(),
                  ),
